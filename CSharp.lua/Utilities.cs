    ...
    public static class Utility
    {
        ...
        public static string GetArgument(this Dictionary<string, string[]> args, string name, bool isOption = false)
        {
            ...
            if (values == null || values.Length == 0)
            {
                ...
                throw new CmdArgumentException(name + " couldn't be found.");
            }
            return values[0];
        }
        ...
        public static bool HasStaticConstructor(this INamedTypeSymbol typeSymbol)
        {
        ...
        public static bool IsStaticLazy(this ISymbol symbol)
        {
            ...
            if (success)
            {
                ...
                return typeSymbol.HasStaticConstructor();
            }
            return success;
        }
        ...
        {
            const string base63Alphabet = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_";
            int basis = base63Alphabet.Length;
            int n = number;
            StringBuilder sb = new StringBuilder();
            while (n > 0)
            {
                char ch = base63Alphabet[n % basis];
                sb.Append(ch);
                n /= basis;
            }
            return sb.ToString();
